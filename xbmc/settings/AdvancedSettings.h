...
class CAdvancedSettings : public ISettingCallback, public ISettingsHandler
{
  public:
    ...
    std::vector<ResolutionVideoLatency> m_videoResolutionLatency;
    ...
    */
    ...
    float GetLatencyTweak(const std::string resolution, bool isHDREnabled);
    bool m_initialized;
